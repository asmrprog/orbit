...
const createTokens: CreateTokens = foundation => ({
  ...
  fontSizeHeadingTitle3: foundation.fontSize.large,
  fontSizeHeadingTitle4: foundation.fontSize.normal,
  fontSizeHeadingTitle5: foundation.fontSize.small,
  ...
  formElementLabelForeground: foundation.palette.ink.normal,
  ...
  fontWeightHeadingTitle4: foundation.fontWeight.medium,
